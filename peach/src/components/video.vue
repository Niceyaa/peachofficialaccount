<template>
    <div class="wrap-box" v-wechat-title="$route.meta.title">
        <div id="wrapp">
            <audio  id="wrap_aud" preload="auto" @ended="stop" :src="audioSrc">
            </audio>
...
<script>
    /*const v1 = "https://www.txjxy.xyz/test/v/1.m4a";
    const v2 = "https://www.txjxy.xyz/test/v/2.m4a";
    const v3 = "https://www.txjxy.xyz/test/v/3.m4a";
    const v4 = "https://www.txjxy.xyz/test/v/4.m4a";
    const v5 = "https://www.txjxy.xyz/test/v/5.m4a";
    const v6 = "https://www.txjxy.xyz/test/v/6.m4a";
    const v7 = "https://www.txjxy.xyz/test/v/7.m4a";
    const v8 = "https://www.txjxy.xyz/test/v/8.m4a";
    const v9 = "https://www.txjxy.xyz/test/v/9.m4a";
    const v10 = "https://www.txjxy.xyz/test/v/10.m4a";
    const v11 = "https://www.txjxy.xyz/test/v/11.m4a";*/
    const v1 = "http://dlty.china-tillage.com/dlty/v/1.m4a";
    const v2 = "http://dlty.china-tillage.com/dlty/v/2.m4a";
    const v3 = "http://dlty.china-tillage.com/dlty/v/3.m4a";
    const v4 = "http://dlty.china-tillage.com/dlty/v/4.m4a";
    const v5 = "http://dlty.china-tillage.com/dlty/v/5.m4a";
    const v6 = "http://dlty.china-tillage.com/dlty/v/6.m4a";
    const v7 = "http://dlty.china-tillage.com/dlty/v/7.m4a";
    const v8 = "http://dlty.china-tillage.com/dlty/v/8.m4a";
    const v9 = "http://dlty.china-tillage.com/dlty/v/9.m4a";
    const v10 = "http://dlty.china-tillage.com/dlty/v/10.m4a";
    const v11 = "http://dlty.china-tillage.com/dlty/v/11.m4a";
    ...
    export default {
        data() {
            return {
                totalSrc: "",
                voiceID: this.$route.params.voiceId,
                title: "2",
